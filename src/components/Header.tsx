...
export default function Header() {
  ...
  return (
    <>
      <header id="main-header" className="sticky top-0 z-40 bg-white border-b border-slate-200 py-3.5 px-4 md:px-8 shadow-xs flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        ...
        <div className="flex flex-wrap items-center gap-3">
          ...
          <div className="flex items-center border border-slate-200 rounded-lg bg-slate-50 p-1 font-mono text-xs shadow-3xs">
            <button
